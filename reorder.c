...
/*   Updated: 2023/03/27 10:05:02 by mpeterso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

/*while both cost_a & cost_b are negative, reverse rotates both 
stacks until either cost_a or cost_b reaches 0*/
...
/*while both cost_a & cost_b are higher than 0, rotates both 
stacks until either cost_a or cost_b reaches 0*/
...
/*once cheapest option is found in 'find_cheapest', lines up stack_a and 
stack_b to appropriate positions using costs in order to push that element 
